...
def Home():
    ...
    - 📁 **Upload Evidence:** 
    Provide supporting documents or media related to a witnessed cyber crime.
    
    - 📚  **Read About Cyber Laws:** 
    Learn about the IT Act and DPDP Act in discussion forums.

    
    """
    )
    st.write("\n\nNavigate around our portal to use the above services. We value your time and commitment to make the society better." )   
...
st.sidebar.image(r"D:\Streamlit sandbox\multipage app\stats\tnp.png")
